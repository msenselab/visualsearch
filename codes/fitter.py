...
class Fitter:
    def __init__(self, data, sub_num, model_type, opt_iter, inits, n_pre_samples = 15):
        '''
        inits are global settings for the experitment
        it is a tuple (total time T, intertrival interval t_w, time step dt, size of grid, lapse rate)
        '''
        ...
        self.opt_DDM = OptDDM(xp, self.model_type, inits)
